...
commonFunc.facebookInstall = function (url) {
    if (!app.getAppName("com.facebook.katana")) {
        if (!httpUtilFunc.downloadFile(url, "/storage/emulated/0/Facebook_v348", 1000 * 60, false) || !commonFunc.installApk("/storage/emulated/0/Facebook_v348", 1000 * 60)) {
            return false
        }
    }
    return true
...
commonFunc.backupUplive = function (targetPackageName) {
    try {
        toastLog("备份Tiktok");
